...
Releases `v0.29.1` through the cancelled `v0.34.1` candidates were never promoted as a new cross-platform Latest. Starting with `v0.34.3`, official macOS and Linux packages return and the complete cross-platform updater manifest is promoted as GitHub Latest again.
