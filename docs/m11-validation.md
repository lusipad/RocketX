...
日期：2026-07-17
状态：M11 实现已合并 `main`；当前按用户决策继续 0.x，v0.20.0 候选等待版本 PR、三平台标签构建与 npm 身份
...
| 三平台工作流能力 | [Desktop Build #29570695188](https://github.com/lusipad/RocketX/actions/runs/29570695188)：版本决策前的 1.0.0 候选完成 Windows、macOS universal、Linux 构建；v0.20.0 仍须在版本 PR 后重新干跑 |
...
- [ ] v0.20.0 版本统一 PR 通过 CI 并合并 `main`。
