...
日期：2026-07-17
状态：M11 实现已合并 `main`；正式标签被外部真人验收、视觉素材与 npm 身份阻塞
...
| 三平台 CI 干跑 | [Desktop Build #29570695188](https://github.com/lusipad/RocketX/actions/runs/29570695188)：Windows、macOS universal、Linux 构建与手动下载产物全部通过；非标签发布步骤按预期跳过 |
