...
> **当前候选基线（2026-07-20，v0.25.6 待发布）：协议生成物 671 个一致、typecheck 通过、test:pure 219/219、test:regression 459/459、test:ui 19/19、Rocket.Chat 8.6.1 冒烟 53/53、应用生态 clean-room 通过、Web 生产构建通过、Rust 38/38（另 3 项显式集成测试均已单独通过）、Windows Release 二进制构建通过**——上两行的日期与数字是 v0.12.1 时点的历史快照，勿据此推导当前状态
