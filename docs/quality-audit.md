...
> **当前候选基线（2026-07-21，v0.25.13 待发布）：协议生成物 671 个一致、typecheck 通过、test:pure 219/219、test:regression 469/469、test:ui 30/30、Rocket.Chat 8.6.1 冒烟 53/53、会话分类 5/5、应用生态 clean-room 通过、插件发布包与 Web 生产构建通过、Rust 45/45（另 2 项显式集成测试在标准门禁中保持 ignored）**——上两行的日期与数字是 v0.12.1 时点的历史快照，勿据此推导当前状态
