...
> **当前候选基线（2026-07-22，v0.25.16 待发布）：协议生成物 671 个一致、typecheck 通过、test:pure 219/219、test:regression 477/477、test:ui 35/35、Rocket.Chat 8.6.1 冒烟 53/53、会话分类 5/5、应用生态 clean-room 通过、插件发布包与 Web 生产构建通过、Rust 桌面端 35/35**——上两行的日期与数字是 v0.12.1 时点的历史快照，勿据此推导当前状态
