...
> **当前候选基线(2026-07-17,v0.20.0 待发布):test:pure 219、test:regression 248、smoke 53、Rust 30；另有 classify 5、Codex app-server 真实 turn、Agent Runner 与应用生态 clean-room 通过**——上两行的日期与数字是 v0.12.1 时点的历史快照,勿据此推导当前状态
