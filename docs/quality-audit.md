...
> **当前候选基线（2026-07-20，v0.25.5 待发布）：协议生成物 671 个一致、typecheck 通过、test:pure 219/219、test:regression 452/452、test:ui 18/18、Rocket.Chat 8.6.1 冒烟 53/53、应用生态 clean-room 通过、Web 生产构建通过、Rust 36/36（另 3 项显式集成测试按设计忽略）、Windows MSI/NSIS 无签名 Release 打包通过**——上两行的日期与数字是 v0.12.1 时点的历史快照，勿据此推导当前状态
