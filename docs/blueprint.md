...
- Release 质量：当前稳定化阶段发布 Windows x64 安装包并面向用户重写 CHANGELOG；M11 的三平台基线以 **v0.20.1** 收口，当前发布候选为 **v0.30.0**，macOS/Linux 待平台验证稳定后恢复；完成真人 G3/G4 与真实视觉素材后再进入 1.0。
